...
from monster_populator import MonsterPopulator
...
class Overlord:
    ...
    def build_dungeon(self):
        level_1 = DungeonLevelBuilder(DungeonType.SIMPLE, height=MAP_HEIGHT, width=MAP_WIDTH).with_room_sizes(6,10).with_max_rooms(30)\
            .with_upward_stairs(0).with_downward_stairs(1).with_monster_populator(MonsterPopulator(1)).build_dungeon_level()
        ...
        level_2 = DungeonLevelBuilder(DungeonType.SIMPLE, height=MAP_HEIGHT, width=MAP_WIDTH).with_room_sizes(6,10).with_max_rooms(30)\
            .with_upward_stairs(1).with_downward_stairs(0).with_monster_populator(MonsterPopulator(2)).build_dungeon_level()
